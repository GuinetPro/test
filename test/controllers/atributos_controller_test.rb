...
class AtributosControllerTest < ActionController::TestCase
  ...
  test "should create atributo" do
    assert_difference('Atributo.count') do
      post :create, atributo: { campo: @atributo.campo, llave: @atributo.llave, producto_id: @atributo.producto_id, valor: @atributo.valor }
    end
  ...
  test "should update atributo" do
    patch :update, id: @atributo, atributo: { campo: @atributo.campo, llave: @atributo.llave, producto_id: @atributo.producto_id, valor: @atributo.valor }
    assert_redirected_to atributo_path(assigns(:atributo))
  end
